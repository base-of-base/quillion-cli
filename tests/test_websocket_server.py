...
class TestServerProcess:
    ...
    def test_run_server_entry_point_not_found(self, temp_project_dir, mock_config, mock_debugger):
        ...
        mock_debugger.error.assert_called_once_with(f"Entry point not found: {expected_entry_point}")

    def test_run_server_with_debugger_flags(self, temp_project_dir, mock_config, mock_debugger):
        ...
        mock_process = Mock()
        with patch('quillion_cli.server.websocket_server.subprocess.Popen') as mock_popen:
    ...
    def test_run_server_popen_exception(self, temp_project_dir, mock_config, mock_debugger):
        ...
        with patch('quillion_cli.server.websocket_server.subprocess.Popen') as mock_popen:
            ...
            assert result is None
            mock_debugger.error.assert_called_once_with("Cannot run server: Permission denied")

    def test_run_server_environment_preserved(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_restart_server_with_existing_process(self, temp_project_dir, mock_config, mock_debugger):
        ...
        with patch('quillion_cli.server.websocket_server.subprocess.Popen') as mock_popen:
            ...
            result = restart_server(mock_config, str(temp_project_dir), mock_old_process)
    ...
    def test_restart_server_terminate_timeout(self, temp_project_dir, mock_config, mock_debugger):
        ...
        mock_old_process.wait.side_effect = subprocess.TimeoutExpired(cmd="test", timeout=5)
    ...
    def test_restart_server_no_existing_process(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_restart_server_run_server_fails(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_run_server_custom_entry_point(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_run_server_entry_point_in_subdirectory(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_environment_variable_types(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_restart_server_preserves_working_directory(self, temp_project_dir, mock_config, mock_debugger):
    ...
    def test_run_server_does_not_clear_existing_env(self, temp_project_dir, mock_config, mock_debugger):
