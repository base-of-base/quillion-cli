...
class TestTemplate:
    ...
    def test_process_templates_multiple_files(self, temp_dirs, sample_context):
        ...
        assert (
            project_dir / "subdir" / "file3.txt"
        ).read_text() == "Third: Test Author"
...
Author: Test Author"""
    ...
    def test_process_templates_jinja2_syntax_with_whitespace(
        self, temp_dirs, sample_context
    ):
...
"""
    ...
    def test_process_templates_template_not_found(
        self, mock_env, temp_dirs, sample_context
    ):
    ...
    def test_process_templates_special_characters(self, temp_dirs):
        ...
        assert (
            ...
            == "Name: Test & Name, Path: some/path/with/slashes, HTML: <div>Test</div>"
        )

    def test_process_templates_preserves_file_extension(
        self, temp_dirs, sample_context
    ):
