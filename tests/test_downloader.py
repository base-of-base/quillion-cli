...
class TestFileDownloader:
    ...
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_success(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
    ...
    def test_downloads_assets_no_assets_found(self, mock_get_assets, temp_project_dir):
        ...
        with patch('quillion_cli.utils.file_downloader.debugger') as mock_debugger:
            ...
            mock_debugger.error.assert_called_once_with("No assets found in the release")
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_partial_assets(self, mock_requests_get, mock_get_assets, temp_project_dir):
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_download_failure(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
        ...
        mock_responses = [
            ...
            Mock(raise_for_status=Mock(side_effect=requests.exceptions.HTTPError("404 Not Found"))),
        ]
        mock_requests_get.side_effect = mock_responses
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_existing_directories(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_progress_tracking(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_correct_urls_called(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
    ...
    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_downloads_assets_file_write_error(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_assets):
    ...
    def test_repo_url_constant(self):
        ...
        expected_url = "https://api.github.com/repos/base-of-base/quillion-core/releases/latest"
        assert REPO_URL == expected_url

    @patch('quillion_cli.utils.file_downloader.get_release_assets')
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_integration_flow(self, mock_requests_get, mock_get_assets, temp_project_dir, mock_release_data):
    ...
    @patch('quillion_cli.utils.file_downloader.requests.get')
    def test_integration_flow_both_functions(self, mock_requests_get, temp_project_dir, mock_release_data):
