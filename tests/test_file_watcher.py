...
class TestNewCommand:
    ...
    def _setup_path_mocks(self, MockPath, test_name, mock_templates_dir, mock_config_path, create_dir_exists=False):
    ...
    def test_new_command_success(self, mock_debugger, mock_process_templates):
        ...
        with patch('quillion_cli.commands.new.Path') as MockPath:
            ...
            mock_project_dir = self._setup_path_mocks(
                MockPath, test_name, mock_templates_dir, mock_config_path, create_dir_exists=False
            )
        ...
        with patch('quillion_cli.commands.new.typer.Exit') as MockExit:
            ...
            try:
                ...
                if str(e) == "Exit called":
                    mock_debugger.error.assert_called_once_with("Project name is required")
                else:
                    raise

    def test_new_command_existing_config_no_overwrite(self, mock_debugger, mock_process_templates):
        ...
        with patch('quillion_cli.commands.new.Path') as MockPath, \
             patch('quillion_cli.commands.new.typer.confirm', return_value=False) as mock_confirm:
            ...
            mock_debugger.warning.assert_called_once_with("quillion.toml already exists in this directory")

    def test_new_command_existing_config_force_overwrite(self, mock_debugger, mock_process_templates):
    ...
    def test_new_command_context_generation(self, mock_debugger, mock_process_templates):
    ...
    def test_new_command_project_dir_creation(self, mock_debugger, mock_process_templates):
