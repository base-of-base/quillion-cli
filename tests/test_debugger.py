...
class TestDebugger:
    ...
    def test_http_server_start_no_color(self, debug_config_no_color, mock_console):
        ...
        calls = mock_console.print.call_args_list
        expected_call = "[green]✓[/] [bold]HTTP server[/] started on [cyan]localhost:8080[/]"
    ...
    def test_banner_shows_when_not_quiet_and_figlet_enabled(self, debug_config, mock_console):
    ...
    def test_message_formatting_edge_cases(self, debug_config, mock_console):
        ...
        with patch.object(debugger, '_format_message') as mock_format:
            ...
            mock_format.assert_called_once_with("", "Message with \n newline and \t tab")
